...
export default class GameController {
   ...
   *  персонажем (она автоматически
   *  пересчитывается в redrawPositions).
   */
  ...
  /**
   * Функция реализует перемещение персонажа
   *  юзера в ячейку по которой был клик,
  ...
  /**
   * Функция реализует ответное действие бота атаку или перемещение,
   *  в зависимости от положения
   * персонажа игрока
   * @returns наносит урон персонажу игрока,
   *  в случае атаки или рандомно выбирает бота и реализует
   *перемещение.
   */
